...
All 25 real endpoints in `apps/movos-api`, prefix `/api/v1` (set in `src/main.ts`). This is the complete set — confirmed by reading every module import in `src/app.module.ts`; no partial or stub routes exist beyond these.
