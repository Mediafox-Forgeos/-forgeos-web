...
**Repository HEAD:** `main` @ `46206f259ce6dd6ec0bb31a42f1f4a4d11451447` (the CAP-004 merge commit, PR #25) — corrected 2026-08-01 (WO-ARGOS-010); previously stale at `bfea8db`, a commit that predated every update note above it.
**Author:** VULCAN
