...
- **✅ 2026-07-24 update (WO-ARGOS-003):** [M001-A-DEC-005](./M001-A_OPEN_DECISIONS_v0.1.md#m001-a-dec-005-approved-2026-07-24-wo-argos-003) — the one decision that blocked CAP-002 from starting cleanly — is now **approved by ARGOS**. The ruling adopts neither of the two options this document originally framed: it introduces the EVSE tier the original recovery flagged as a real open question, but retires "Charger" as a persisted entity entirely rather than keeping it as originally recommended. Approved hierarchy: `Site → ChargingStation → EVSE → Connector`. "Charger" survives as commercial/UI terminology only. CAP-002 (`feat/cap-002-charging-core-domain`) implements this. See the updated [Open Decisions](./M001-A_OPEN_DECISIONS_v0.1.md), [Ubiquitous Language](./M001-A_UBIQUITOUS_LANGUAGE_v0.1.md), [Domain Map](./M001-A_DOMAIN_MAP_v0.1.md#approved-hierarchy-post-dec-005-2026-07-24), and [CAP-002 Charging Terminology Mapping](./CAP-002_CHARGING_TERMINOLOGY_MAPPING.md).
